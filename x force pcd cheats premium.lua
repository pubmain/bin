...
local Window =
    ...
    {
        Name = "X-FORE Cheats 💸 GUI",
        LoadingTitle = "X-FORE Cheats Wersja Płatna 💸",
        LoadingSubtitle = "by X-F0RE",
        ConfigurationSaving = {
            Enabled = false,
        ...
        KeySettings = {
            ...
            FileName = "X-FORE KEY", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
            SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
            GrabKeyFromSite = true, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
            Key = {"PREMIUM10ZL"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
        }
    }
)
...
Rayfield:Notify(
    {
        Title = "Aktywowałeś Script",
        Content = "Dziękujemy Za Nasze Wspieranie!",
        Duration = 5,
        Image = 13047715178,
        Actions = {
...
local Button1 =
    ...
    {
        Name = "Money Add (Visual) Anti-cheat nie pozwala nam zrobic",
        Callback = function()
            game.Players.LocalPlayer.leaderstats.Money.Value = 65783897
            game.Players.LocalPlayer.leaderstats.Money.Value = 756346390
        end
    }
)
...
local Button1 =
    MainTab:CreateButton(
    {
        Name = "AK-47 (Shift Nie Klikaj i nie strzelaj w auta)",
        Callback = function()
            do
                    ...
                    sandbox(
                        ...
                        function()
                            ...
                            local Settings = {
                                ...
                                GuiPos = Vector2.new(
                                    script.Gui.Frame.Position.X.Scale,
                                    script.Gui.Frame.Position.Y.Scale
                                ),
                                OneHanded = false,
                                FakeArms = false,
                                FakeArmTransparency = 0.5,
                                RightPos = CFrame.new(-0.75, -0.6, 0.45) *
                                    CFrame.fromEulerAnglesXYZ(math.rad(-90), math.rad(-16), 0),
                                LeftPos = CFrame.new(0.4, 0.65, 1.1) *
                                    CFrame.fromEulerAnglesXYZ(math.rad(320), 0.6, math.rad(-84)),
                                ...
                                SprintArmOffset = CFrame.new(0.25, 0.125, 0.25) *
                                    CFrame.Angles(math.rad(-30), math.rad(35), 0),
                                DropHats = true
                            }
                            ...
                            local Ignore_Model =
                                Workspace:FindFirstChild("Ray_Ignore") or Instance.new("Model", Workspace)
                            ...
                            function Fire(Mouse)
                                ...
                                local Ray =
                                    ...
                                    (CFrame.new(Character.Head.Position, Mouse.Hit.p) * Spread).lookVector.unit *
                                        Settings.Range
                                )
                                ...
                                if (Hit and Hit.Parent:FindFirstChild("Humanoid")) then
                                    ...
                                    if
                                        (Settings.AntiTK and not Hit_Player.Neutral and
                                            (Hit_Player.TeamColor == Player.TeamColor))
                                     then
                                        return
                                    end
                                    ...
                                    if (Hit.Name == "Head") then
                                        Humanoid.Health =
                                            Humanoid.Health -
                                            math.random(Settings.HeadShotDamage[1], Settings.HeadShotDamage[2])
                                    else
                                        Humanoid.Health =
                                            Humanoid.Health - math.random(Settings.Damage[1], Settings.Damage[2])
                                    end
                                elseif Hit then
                            ...
                            Tool.Equipped:connect(
                                function(Mouse)
                                    ...
                                    Gui.Frame.Position =
                                        UDim2.new(
                                        Settings.GuiPos.X,
                                        Gui.Frame.Position.X.Offset,
                                        1.1,
                                        Gui.Frame.Position.Y.Offset
                                    )
                                            ...
                                            if (Can_Shoot and (Ammo.Value > 0) and (Character.Humanoid.Health > 0)) then
                                                ...
                                                while true do
                                                    ...
                                                    Camera.CoordinateFrame =
                                                        CFrame.new(Camera.Focus.p) *
                                                        (Camera.CoordinateFrame - Camera.CoordinateFrame.p) *
                                                        CFrame.Angles(math.abs(Settings.Recoil), 0, 0) *
                                                        CFrame.new(
                                                            0,
                                                            0,
                                                            (Camera.Focus.p - Camera.CoordinateFrame.p).magnitude
                                                        )
                                                    ...
                                                    if
                                                        (not Settings.Automatic or (Ammo.Value <= 0) or
                                                            (Character.Humanoid.Health <= 0) or
                                                            not Mouse_Held)
                                                     then
                                                        break
                                                    end
                                                ...
                                                Can_Shoot = true
                                            elseif
                                                (Can_Shoot and (Character.Humanoid.Health > 0) and
                                                    Tool.Handle:FindFirstChild("Click"))
                                             then
                                    ...
                                    Mouse.KeyDown:connect(
                                        function(Key)
                                            if
                                                ((Key:upper() == Settings.ReloadKey:upper()) and Can_Shoot and
                                                    (StoredAmmo.Value > 0) and
                                                    not Aiming)
                                             then
                                                if
                                                    ((Settings.IncludeChamberedBullet and
                                                        (Ammo.Value == (Settings.Ammo + 1))) or
                                                        (not Settings.IncludeChamberedBullet and
                                                ...
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.73, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-92), math.rad(-16), 0.21)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.35, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(286), 0.81, math.rad("-0"))
                                                wait(0.04)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.71, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-87), math.rad(-16), 0.22)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.35, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(298), 0.92, math.rad("-0"))
                                                wait(0.04)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.69, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-87), math.rad(-16), 0.23)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.35, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(298), 0.883, math.rad("-0"))
                                                wait(0.04)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.705, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-87), math.rad(-16), 0.225)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.35, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(298), 0.864, math.rad("-0"))
                                                wait(0.07)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.715, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-87), math.rad(-16), 0.215)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.35, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(298), 0.855, math.rad("-0"))
                                                Tool.Handle.M1:play()
                                                ...
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.73, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-107), math.rad(-16), 0.21)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.35, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(301), 0.85, math.rad("-0"))
                                                wait(0.04)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.71, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-106.75), math.rad(-16), 0.22)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.3, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(309), 0.8, math.rad("-0"))
                                                wait(0.04)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.69, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-106.6), math.rad(-16), 0.23)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.3, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(314), 0.76, math.rad("-0"))
                                                wait(0.04)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.66, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-106.5), math.rad(-16), 0.24)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.25, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(322), 0.72, math.rad("-0"))
                                                wait(0.04)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.63, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-106.4), math.rad(-16), 0.25)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.25, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(329), 0.68, math.rad("-0"))
                                                wait(0.04)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.59, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-105.9), math.rad(-16), 0.26)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.2, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(332), 0.64, math.rad("-0"))
                                                wait(0.04)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.55, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-104.4), math.rad(-16), 0.27)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.2, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(335), 0.61, math.rad("-0"))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.5, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-103), math.rad(-16), 0.28)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.95, 0.15, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(338), 0.58, math.rad("-0"))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.44, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-102.7), math.rad(-16), 0.29)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.95, 0.15, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(342), 0.55, math.rad("-0"))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.38, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-101.5), math.rad(-16), 0.3)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.025, 0.1, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(338), 0.54, math.rad("-0"))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.37, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-100.4), math.rad(-16), 0.3)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.1, 0.1, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(334), 0.57, math.rad("-0"))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.36, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-99.4), math.rad(-16), 0.3)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.12, 0.05, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(329), 0.6, math.rad("-0"))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.35, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-98.5), math.rad(-16), 0.3)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.14, 0.05, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(325), 0.64, math.rad("-0"))
                                                wait(0.08)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.34, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.7), math.rad(-16), 0.3)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.16, 0, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(321), 0.68, math.rad("-0"))
                                                ...
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.33, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97), math.rad(-16), 0.3)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.18, 0, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(315), 0.72, math.rad("-0"))
                                                ...
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.32, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-96.4), math.rad(-16), 0.3)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.2, -0.05, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(309), 0.76, math.rad("-0"))
                                                ...
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.3, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-95.9), math.rad(-16), 0.31)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.22, -0.05, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(303), 0.8, math.rad("-0"))
                                                ...
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.28, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-95.5), math.rad(-16), 0.32)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.24, -0.1, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(297), 0.85, math.rad("-0"))
                                                ...
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.26, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-95.2), math.rad(-16), 0.33)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.26, -0.1, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(291), 0.9, math.rad("-0"))
                                                ...
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.24, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.1), math.rad(-16), 0.34)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.28, -0.15, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(285), 0.95, math.rad("-0"))
                                                ...
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.22, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.8), math.rad(-16), 0.35)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.3, -0.15, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(279), 1, math.rad("-0"))
                                                ...
                                                wait(0.1)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.27, -0.6, 0.35) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.8), math.rad(-16), 0.21)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.26, -0.2, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(276), 0.995, math.rad("-0"))
                                                wait(0.09)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.32, -0.6, 0.25) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.7), math.rad(-16), 0.08)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.23, -0.25, 0.5) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(273), 0.99, math.rad("-0"))
                                                wait(0.09)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.37, -0.6, 0.15) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.6), math.rad(-16), -0.04)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.19, -0.3, 0.32) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(270), 0.985, math.rad("-0"))
                                                wait(0.09)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.42, -0.6, 0.05) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.5), math.rad(-16), -0.18)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.16, -0.13, 0.48) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(267), 0.98, math.rad("-0"))
                                                wait(0.09)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.47, -0.6, -0.05) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.6), math.rad(-16), -0.31)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.13, 0.03, 0.64) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(264), 0.975, math.rad("-0"))
                                                wait(0.1)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.52, -0.6, -0.15) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.7), math.rad(-16), -0.45)
                                                Left_Weld.C1 =
                                                    CFrame.new(1.1, 0.2, 0.8) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(261), 0.97, math.rad("-0"))
                                                Tool.Handle.M3:play()
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.52, -0.61, -0.15) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.8), math.rad(-16), -0.45)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.98, 0.06, 0.79) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(260.3), 1, math.rad("-0"))
                                                Tool.A1.Mesh.Offset = Vector3.new(0, 0, 0.18)
                                                Tool.A2.Mesh.Offset = Vector3.new(0, 0, 0.18)
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.52, -0.62, -0.15) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-97.9), math.rad(-16), -0.45)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.86, -0.06, 0.78) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(259.6), 1.03, math.rad("-0"))
                                                Tool.A1.Mesh.Offset = Vector3.new(0, 0, 0.36)
                                                Tool.A2.Mesh.Offset = Vector3.new(0, 0, 0.36)
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.52, -0.63, -0.15) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-98), math.rad(-16), -0.45)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.74, -0.2, 0.77) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(259), 1.07, math.rad("-0"))
                                                ...
                                                wait(0.2)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.55, -0.6, -0.06) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-96.6), math.rad(-16), -0.38)
                                                Left_Weld.C1 =
                                                    CFrame.new(1, 0.26, 0.84) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(269), 0.91, math.rad(-12))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.58, -0.6, 0.02) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-95.5), math.rad(-16), -0.32)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.9, 0.32, 0.88) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(277), 0.86, math.rad(-24))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.61, -0.6, 0.1) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-94.4), math.rad(-16), -0.25)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.8, 0.39, 0.92) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(286), 0.81, math.rad(-36))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.65, -0.6, 0.19) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-93.3), math.rad(-16), -0.19)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.7, 0.45, 0.97) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(294), 0.75, math.rad(-48))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.68, -0.6, 0.27) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-92.2), math.rad(-16), -0.12)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.6, 0.52, 1.01) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(303), 0.7, math.rad(-60))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.71, -0.6, 0.36) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-91.1), math.rad(-16), -0.06)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.5, 0.58, 1.05) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(311), 0.65, math.rad(-72))
                                                wait(0.05)
                                                Right_Weld.C1 =
                                                    CFrame.new(-0.75, -0.6, 0.45) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(-90), math.rad(-16), 0)
                                                Left_Weld.C1 =
                                                    CFrame.new(0.4, 0.65, 1.1) *
                                                    CFrame.fromEulerAnglesXYZ(math.rad(320), 0.6, math.rad(-84))
                                                CanUpdateGui = true
                                                ...
                                                Reloading = false
                                            elseif
                                                ((Key:upper() == Settings.SprintKey:upper()) and Settings.Sprint and
                                                    not Aiming)
                                             then
                                                Sprinting = true
                                    ...
                                    Mouse.Button2Down:connect(
                                        function()
                                            if
                                                (not Reloading and not Sprinting and not Aiming and
                                             ...
                                             then
                                                ...
                                                Right_Weld.C1 =
                                                    Character.Head.CFrame:toObjectSpace(Settings.AimPart.CFrame)
                                    ...
                                    wait()
                                    Camera.Changed:connect(
                                        function()
                                            if
                                                (((Camera.Focus.p - Camera.CoordinateFrame.p).magnitude < 1) and
                                                    Equipped)
                                             then
                                                ...
                                                Character.Torso.Neck.C0 =
                                                    CFrame.new(0, 1.5, 0) *
                                                    CFrame.Angles(
                                                        math.asin((Mouse.Hit.p - Mouse.Origin.p).unit.y),
                                                        0,
                                                        0
                                                    )
                                            end
                            ...
                            Tool.Equipped:connect(
                                function(Mouse)
                                    ...
                                    if (Settings.FakeArms and not Fake_Arm_Right) then
                                        Fake_Arm_Right, Fake_Arm_Left =
                                            Character["Right Arm"]:Clone(),
                                            Character["Left Arm"]:Clone()
                                        ...
                                        if Settings.CharacterMeshes then
                                            for i, v in pairs(Character:GetChildren()) do
                                                if
                                                    ((v:IsA("CharacterMesh") and (v.BodyPart == Enum.BodyPart.LeftArm)) or
                                                        (v:IsA("CharacterMesh") and
                                                            (v.BodyPart == Enum.BodyPart.RightArm)))
                                                 then
                            ...
                            Tool.Unequipped:connect(
                                function()
                                    ...
                                    if (Character and Left_Weld and Right_Weld) then
                                        Arms_Made = false
                                        local Torso = Character.Torso
                                        Torso["Right Shoulder"].Part1, Torso["Left Shoulder"].Part1 =
                                            Character["Right Arm"],
                                            Character["Left Arm"]
                                        Left_Weld:Destroy()
                                        Right_Weld:Destroy()
...
local Button1 =
    MainTab:CreateButton(
    {
        Name = "Verified Chat Tollowanie Graczy Werfikacją",
        Callback = function()
                    ...
                    if not flying then
                        ...
                        while _G.Fly do
                            ...
                            if hrp then
                                ...
                                if SPACE then
                                    moveDir = moveDir + hrp.CFrame.UpVector
                                end
...
local VehicleSection = VehicleTab:CreateSection("Mods")
...
local function CarMod()
    ...
    game:GetService("RunService").Heartbeat:Connect(
        function()
            if not _G.CarMods then
                return
            end

            car = workspace.Cars:FindFirstChild(player.Name)
            ...
            if car then
                ...
                local hrp = car:FindFirstChild("Body")

                velocity = Vector3.new(0, currentVelocity.Y, 0)

                if hrp then
                    if uis:IsKeyDown(Enum.KeyCode.W) then
                        velocity = currentVelocity + (driveSeat.CFrame.LookVector * (_G.CarMods_H * 0.1))
                    elseif uis:IsKeyDown(Enum.KeyCode.S) then
                        velocity = currentVelocity - (driveSeat.CFrame.LookVector * (_G.CarMods_H * 0.1))
                    end

                    driveSeat.AssemblyLinearVelocity = velocity
                else
                    warn("Body not found!")
                end
            else
                warn("Can't Find Vehicle")
            end
        end
    )
end
...
local TeleportTab = Window:CreateTab("🏝 Teleports PCD MAP", nil) -- Title, Image
...
local TeleportTab = Window:CreateTab("🌎Teleport Other", nil) -- Title, Image
local TeleportSection = TeleportTab:CreateSection("🌎Teleport Stolen Car")
...
local TeleportSection = TeleportTab:CreateSection("🤫Secrets")
...
local Button =
    TeleportTab:CreateButton(
    {
        ...
        Callback = function()
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                CFrame.new(2208.1001, 138.828461, 934.398926, 1, 0, 0, 0, 1, 0, 0, 0, 1)
        end
    }
)
...
local Button =
    TeleportTab:CreateButton(
    {
        ...
        Callback = function()
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                CFrame.new(-32.9410133, 119.83844, 9778.17578, 0, 0, -1, 0, 1, 0, 1, 0, 0)
        end
    }
)
...
local CreditsTabs = Window:CreateTab(©️ Credits", nil) -- Title, Image
local CreditsSection = CreditsTabs:CreateSection("Współpraca")

local CreditsSection =
    CreditsTabs:CreateLabel(
    "Współpraca: VoidMafia // discord.gg/VoidMafia // dsc.gg/Voidmafia00",
    4483362458,
    Color3.fromRGB(255, 255, 255),
    false
) -- Title, Icon, Color, IgnoreTheme

coroutine.wrap(CarMod)()
